...
const ProfileBar = () => {
  return (
    <div
      id="head-profile"
      className=" transition duration-150 ease-in-out flex flex-wrap xl:flex-nowrap  w-full   relative"
    >
        ...
        <div className="relative image-profile flex justify-center xl:justify-end">
          <picture className="flex justify-center xl:justify-end">
            ...
            <img
              ...
              alt="Profile Picture"
              className={` w-[40%]  rounded-full border-4 object-cover `}
            />
          </picture>
        </div>
      </div>
      <div id="profile-desc" className="w-full xl:w-[70%]">
        <div className="desc-profile flex flex-wrap justify-center xl:justify-start">
          <h1 className="xl:text-3xl text-2xl text-center  xl:text-left font-medium w-full">
