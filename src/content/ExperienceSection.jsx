  ...
  const dataExperience = [
    ...
    },
    {
      ...
      desc: [
        ...
        "Learn to Create Front-End for Beginners",
      ],
    },
    {
      ...
      desc: [
        "Assisting lecturers in the practicum implementation process",
        "Participate in the development of practicum materials",
        "Maintain and maintain laboratory equipment and cleanliness.",
      ],
    },
    {
      ...
      <div className="education-section flex justify-center items-center">
        <div className="education-content-1">
          {dataExperience.map((experience, id, arr) => (
            <div
              key={id}
              className="education-data grid grid-cols-[auto] mb-5 xl:mb-0 xl:grid-cols-[1fr_max-content_1fr] gap-0 xl:gap-6  "
            >
              {(id + 1) % 2 !== 0 && (
                <>
                  <div></div>
              ...
              <div
                key={id}
                className={`bg-white text-black dark:bg-slate-900 dark:text-white shadow-md p-5 shadow-sky-400 rounded-lg`}
              >
